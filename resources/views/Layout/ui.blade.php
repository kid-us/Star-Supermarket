...
<body id="body" class="section-one">
            ...
            <nav class="mt-3">
                <div class="row fw-semibold">
                    ...
                    @if (session('user-name'))
                        <div class="col-2 drop-options small">
                            <p id="dash-link" class="cursor bi bi-person-circle text-center"> {{ session('user-name') }}
                    ...
                    <div class="col-1 small">
                        <div id="cart-link" class="position-relative cursor" title="Cart">
                            ...
                            {{-- <img class="cart-img " src=" {{ asset('Img/cart.png') }}" alt="" width="20px"> --}}
                            <span id="counter"
    ...
    <div id="small-nav-bar" class="bg-nice fixed-top small border-bottom">
        <div class="d-block d-md-none">
            ...
            {{-- Small device sidebar menu page --}}
            <div id="menu-page" class="px-3 pt-3 hidden animate__animated animate__fadeInLeft fw-semibold overflow">
                <ul class="menu-bar">
                    ...
                    <h1 class="fs-1">
                        ...
                        {{-- <span class="ms-5">
                            <button id="hide"class="btn fs-1 ms-5 text-light bg-danger"> &times;</button>
                        </span> --}}
                    </h1>
    ...
    <div id="cart-page" class="cart-page hidden shadow-lg animate__animated animate__fadeInRight text-light">
        <p class="my-cart-title px-4 pt-4">
            ...
            {{-- <span id="close-cart" class="cursor">
                <a id="close-cart" class="cursor btn btn-danger float-end">&times; </a>
            </span> --}}
        </p>
            ...
            <div class="carousel-inner">
                <div class="carousel-item active" data-bs-interval="35000">
                    @for ($i = 0; $i < count($site); $i++)
                        @if ($site[$i]->imageFor && $site[$i]->sloganFor == 'Website')
                            <img src="{{ asset('site/' . $site[$i]->image) }}" class="img" alt="...">
                            <div class="cover-slogan">
                                <h2 class="">{{ $site[$i]->slogan }}</h2>
                                {{-- <a href="#" class="btn buy-link small px-4 mb-5 py-2 fw-semibold">Shop
                                    Now</a> --}}
                            </div>
                        @endif
                    @endfor
    ...
    {{-- small and extrasmall device search --}}
    ...
    {{-- Large and medium device search --}}
