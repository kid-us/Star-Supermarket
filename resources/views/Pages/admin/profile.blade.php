        ...
        <div class="row justify-content-center">
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                <div class="text-center shadow rounded p-3 section-two">
                    ...
                    @endif
                    <h4> {{ $admin[0]->username }} </h4>
                    <li class="small text-secondary">Adminstrator</li>
                    <div class="ms-5 mt-2">
                        <p class="bi bi-envelope-fill text-start"> {{ $admin[0]->email }} </p>
                        <p class="bi bi-flag-fill text-start"> {{ $admin[0]->country }} </p>
                        <p class="bi bi-building text-start"> {{ $admin[0]->city }} </p>
                        <p class="bi bi-geo-alt-fill text-start"> {{ $admin[0]->address }} </p>
                        <p class="bi bi-telephone-fill text-start"> {{ $admin[0]->tel }} </p>
                    </div>
                </div>
            ...
            <div class="col-lg-8 col-md-8 col-12 col-xs-12">
                <div class="shadow rounded p-4 section-two">
                    ...
                    <p>Hello <span class="text-danger fs-3"> {{ $admin[0]->username }}</span> you are the admin of the
