        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                <div class="section-two p-4 rounded shadow">
                    <h6 class="mb-4">{{ count($employee) }} Hired Employee</h6>
                    @if (session('deleted'))
                    ...
                    @for ($i = 0; $i < count($employee); $i++)
                        ...
                        <div class="row mb-3 shadow small">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 mt-2">
                                <h4> {{ $employee[$i]->username }} </h4>
                                <li>{{ $employee[$i]->role }}</li>
                            </div>

                            <div class="col-lg-6 col-md-12 col-sm-6 col-xs-12">
                                <p> <span class="bi bi-envelope-fill"> </span> {{ $employee[$i]->email }} </p>
                                <p> <span class="bi bi-flag-fill"> </span> {{ $employee[$i]->country }} </p>
                                <p> <span class="bi bi-building"> </span> {{ $employee[$i]->city }} </p>

                            </div>
                            <div class="col-6">
                                <p> <span class="bi bi-telephone-fill"> </span> {{ $employee[$i]->tel }} </p>
                                <p> <span class="bi bi-geo-alt-fill"> </span> {{ $employee[$i]->address }} </p>
                            </div>
                            <div class="col-12 mb-2">
                                <form action="/admin/fire" method="POST">
                                    @csrf
                                    <input type="text" name="fire-username" value="{{ $employee[$i]->username }}" hidden>
                                    <input type="text" name="fire-email" value="{{ $employee[$i]->email }}" hidden>
                                    <a class="fire-btn btn btn-danger p-1 w-100"
                                        data-num="{{ $employee[$i]->id }}">Fire</a>

                                    <div id="sure{{ $employee[$i]->id }}" class="mt-2 hidden">
                                        <span>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                ...
                                <div class="form-floating small mb-4">
                                    <select type="text" name="role"
                                        class="form-control @error('role') border-error
                                        @enderror">
                                        {{-- <option selected hidden></option> --}}
                                        {{-- <option value="admin">Admin</option> --}}
                                        <option value="delivery">Delivery</option>
                                    </select>
                                    {{-- <input type="text" name="role" class="form-control" placeholder="Role" readonly
                                        value="delivery"> --}}
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                ...
                                <div class="form-floating small mb-4">
                                    ...
                                    @enderror
                                    @if (session('error'))
                                        <small class="small text-danger">{{ session('error') }}</small>
                                    @endif
                                </div>
                                <div class="form-floating small mb-4">
                                    <input type="password" name="con-password"
                                        class="form-control @error('con-password')
                                        border-error
                                    @enderror"
                                ...
                                <div class="form-floating small mb-4">
                                    <input type="text" name="city"
                                        ...
                                        border-error
                                    @enderror"
                                        placeholder="Confirm Password" value="{{ old('city') }}">
