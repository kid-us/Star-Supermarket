    ...
    <div class="container form-container fw-semibold">
        ...
        <div class="rounded mt-3 small bg pad">
            ...
            <div class="row justify-content-center fw-semibold">
                ...
                <form action="/star/delivery-login-done" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\Kid_us\Desktop\Supermarket\resources\views/Pages/employee/deliveryAuth.blade.php ENDPATH**/ ?>